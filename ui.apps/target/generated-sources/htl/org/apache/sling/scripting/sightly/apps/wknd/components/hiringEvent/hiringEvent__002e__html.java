 ...
 * under the License.
 ******************************************************************************/
package org.apache.sling.scripting.sightly.apps.wknd.components.hiringEvent;
...
public final class hiringEvent__002e__html extends RenderUnit {
...
out.write("<div class=\"cmp-hiringevent\">\r\n    <div class=\"cmp-hiringevent__title\">");
{
...
{
    Object var_testvariable3 = renderContext.getObjectModel().resolveProperty(_global_model, "message");
    if (renderContext.getObjectModel().toBoolean(var_testvariable3)) {
        ...
        {
            Object var_4 = renderContext.call("xss", renderContext.getObjectModel().resolveProperty(_global_model, "message"), "text");
